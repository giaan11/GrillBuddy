...
namespace GrillBuddy
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Grill_Buddy", Version = "v1" });
                ...
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Insert the authentication token starting with 'Bearer'"
                });
                ...
                {
                    {
                        ...
                        Array.Empty<string>() //o new string[] {}
                    }
                });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Grill_Buddy v1"));
            }
